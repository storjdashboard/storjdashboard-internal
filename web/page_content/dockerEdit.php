<?php 
$id = $_GET['id'];
$nodes_query = "SELECT * FROM $database_sql.docker where id = '$id'";
...
$docker_query = "UPDATE `$database_sql`.`docker` SET `port`='$server_port', `server_ip`='$server_ip' WHERE  `id`='$node_id';";
